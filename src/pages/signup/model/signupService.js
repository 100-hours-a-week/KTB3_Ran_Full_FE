...
async function SignupService({
  ...
  const passwordConfirmError = validateConfirmPassword(passwordConfirmProps);
  const usernameFieldError = validateUsername(username);

  //유효성 검사
  emailField.helperText = emailError;
  passwordField.helperText = passwordError;
  passwordConfirmField.helperText = passwordConfirmError;
  usernameField.helperText = usernameFieldError;
