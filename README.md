...
**Mogi Logi(모기로기)** 는 “기록 자체를 습관화”하는 것을 목표로 만든 **커뮤니티 기반 기술 기록 플랫폼**입니다.


이 프로젝트는 기술 블로그의 핵심 목적(기록 → 학습력 강화)과 행동 변화 이론·학습 이력 기반 학습 모델에서 얻은
**“작은 배움이 장기적 성장에 영향을 준다”는** 관점을 반영하고 있습니다.
